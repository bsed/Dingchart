...
public class NativeWindowHelper {
    ...
    public static void SetWindowNoBorder(IntPtr hWnd) {
        var oldstyle = (int) GetWindowLong(hWnd, GWL_STYLE);
    ...
    public static void SetWindowNoBorder(Window win) {
    ...
    public static bool UpdateWindow(Window win) {
        var hwnd = new WindowInteropHelper(win).Handle;
        return UpdateWindow(hwnd);
    }

    public static int PostMessage(Window win, int Msg, int wParam, int lParam) {
        var hwnd = new WindowInteropHelper(win).Handle;
