...
public class MessageTypeAVGroupRefuseMessage : Message {
    ...
    public override String createContentJsonStr() {
        ...
        try {
            ...
            Log.Error(typeof(MessageTypeAVGroupRefuseMessage), ex);
        }
    ...
    */
    public MessageTypeAVGroupRefuseMessage toModel(String jsonStr) {
        ...
        try {
            ...
            Log.Error(typeof(MessageTypeAVGroupRefuseMessage), e);
        }
        return null;
    }
