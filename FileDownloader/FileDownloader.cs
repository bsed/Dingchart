...
public class FileDownloader : IFileDownloader {
    ...
    private long currentDownloadPersent;
    ...
    /// </summary>
    public IDnsFallbackResolver DnsFallbackResolver {
        get;
        set;
    }
    ...
    /// </summary>
    public TimeSpan DelayBetweenAttempts {
        get;
        set;
    }
    ...
    /// </summary>
    public TimeSpan SafeWaitTimeout {
        get;
        set;
    }
    ...
    /// </summary>
    public TimeSpan SourceStreamReadTimeout {
        get;
        set;
    }
    ...
    public void SetCookieContainer(CookieContainer cookieContainer) {
        ...
        this.downloadWebClient.setCookieContainer(cookieContainer);
    }
    ...
    private void DownloadFromCache(string cachedResource) {
        ...
        OnDownloadProgressChanged(this, new DownloadFileProgressChangedArgs(100, TotalBytesToReceive, TotalBytesToReceive, GetHttpHeaders(this.fileSource)));
    ...
    private void OnDownloadProgressChanged(object sender, DownloadProgressChangedEventArgs args) {
        var e = new DownloadFileProgressChangedArgs(args.ProgressPercentage, args.BytesReceived, args.TotalBytesToReceive, GetHttpHeaders(this.fileSource));
    ...
    private void OnDownloadProgressChanged(object sender, DownloadFileProgressChangedArgs args) {
        ...
        if (this.currentDownloadPersent < args.ProgressPercentage) {
            this.currentDownloadPersent = args.ProgressPercentage;
    ...
    private void InvokeDownloadCompleted(CompletedState downloadCompletedState, string fileName, Exception error = null, bool fromCache = false) {
        ...
        DownloadFileCompleted.SafeInvoke(this, new DownloadFileCompletedArgs(downloadCompletedState, fileName, this.fileSource, downloadTime, TotalBytesToReceive, BytesReceived, error, GetHttpHeaders(this.fileSource)));
    }
    ...
    private void OnWorkerProgressChanged(object sender, StreamCopyProgressEventArgs eventArgs) {
        ...
        OnDownloadProgressChanged(this, new DownloadFileProgressChangedArgs(progressPercentage, eventArgs.BytesReceived, TotalBytesToReceive, GetHttpHeaders(this.fileSource)));
    }
