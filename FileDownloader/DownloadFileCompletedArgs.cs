...
public class DownloadFileCompletedArgs : EventArgs {
    ...
    /// <param name="responseHeaders">Exception object</param>
    public DownloadFileCompletedArgs(CompletedState state, string fileName, Uri fileSource, TimeSpan downloadTime, long bytesTotal, long bytesReceived, Exception error, WebHeaderCollection responseHeaders) {
        State = state;
        FileName = fileName;
