...
public class DownloadFileProgressChangedArgs : ProgressChangedEventArgs {
    ...
    ///  <param name="responseHeaders">Total bytes to receive</param>
    ///
    public DownloadFileProgressChangedArgs(int progressPercentage, long bytesReceived, long totalBytesToReceive, WebHeaderCollection responseHeaders)
